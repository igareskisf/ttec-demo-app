...
This is only some of the ways for improving the application. Of course there are other possibilities that will be left for further research, discussion and implementation.